    ...
    <form action="simpan.php" method="post">
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td>No.IC</td>
                    <td><input type="number" name="nokpwarden" required minlength="12" maxlength="12"></td>
                </tr>
                <tr>
                    <td>Katalaluan</td>
                    <td><input type="password" name="kata" required minlength="5" maxlength="12"></td>
                </tr>
                <tr>
                    <td colspan="2">
    ...
    <form action="kemaskini.php" method="post">
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td>No. IC</td>
                    <td><input type="number" name="nokpwarden" required value="<?php echo $row->nokpwarden; ?>" minlength="12" maxlength="12"></td>
                </tr>
                <tr>
                    <td>Katalaluan</td>
